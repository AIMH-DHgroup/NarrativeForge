# EventWeaver all-preset experiments: brief input strategy.
...
$NUM_CTX = 8192
$OUTPUT_DIR = "outputs_all_brief"
$BENCH_DIR = "benchmark_all_brief"
...
Write-Host "Brief input all-preset experiment completed." -ForegroundColor Green
