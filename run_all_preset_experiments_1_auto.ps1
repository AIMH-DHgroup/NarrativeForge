# EventWeaver all-preset experiments: auto input strategy.
...
$NUM_CTX = 8192
$OUTPUT_DIR = "outputs_all_auto"
$BENCH_DIR = "benchmark_all_auto"
...
Write-Host "Auto input all-preset experiment completed." -ForegroundColor Green
