# EventWeaver all-preset experiments: compact RAG input strategy.
...
$NUM_CTX = 8192
$OUTPUT_DIR = "outputs_all_rag"
$BENCH_DIR = "benchmark_all_rag"
...
Write-Host "Running all-preset experiment for compact RAG" -ForegroundColor Green
...
python -m eventweaver all $CASE_STUDIES `
  ...
  --outdir $BENCH_DIR `
  --excel
Stop-If-Failed "all-preset experiment (compact RAG)"
...
Write-Host "Compact RAG all-preset experiment completed." -ForegroundColor Green
